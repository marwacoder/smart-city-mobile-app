...
export const homeBanner = require('../assets/images/home_banner.png');
...
export const orderFood = require('../assets/images/order_food.png');

export const hikingWoman = require('../assets/images/hiking-woman.jpg');
export const womanPhoto = require('../assets/images/woman-photo.jpg');
...
const crispy_chicken_burger = require('../assets/images/crispy-chicken-burger.jpg');
const fries_restaurant = require('../assets/images/fries-restaurant.jpg');
const fly = require('../assets/images/fly.jpg');
export default {
  beach,
  fly,
  hikingWoman,
