    ...
    return (
      <View style={style.topHotelCard}>
        <TouchableOpacity
          ...
          <Image style={style.topHotelCardImage} source={room.image} />
          <View style={{paddingVertical: 5, paddingHorizontal: 10}}>
            <Text style={{fontSize: 10, fontWeight: 'bold'}}>{room.name}</Text>
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', color: COLORS.grey}}>Room (s)</Text>
          <TouchableOpacity>
        ...
        <FlatList
          ...
          renderItem={({item}) => <TopHotelCard room={item} />}
        />
      </ScrollView>
    </SafeAreaView>
  );
